...
OR executor_deadline.execdatecurr::date = '0001-1-1'::date THEN NULL ELSE executor_deadline.execdatecurr::date END AS deadline,
...
JOIN ss_moduletype module_type ON module.type = module_type.id AND module.type_type = module_type.type_type
...
LEFT JOIN responsible_executors responsible_executor ON responsible_executor.access_object_id = resolution_base.id -- или другое подходящее условие соединения
